...
/**
 * Created by venkatesh on 27/12/16.
 */

@Component(lazyload = false)

public class MyListComponent extends WXVContainer<BounceRecyclerView> implements
        IRecyclerAdapterListener<ListBaseViewHolder>,IOnLoadMoreListener,Scrollable {
    public static final String TRANSFORM = "transform";
    public static final String LOADMOREOFFSET = "loadmoreoffset";
    private String TAG = "MyListComponent";
    ...
    public MyListComponent(WXSDKInstance instance, WXDomObject node, WXVContainer parent) {
    ...
    protected BounceRecyclerView initComponentHostView(@NonNull Context context) {
        ...
        if (transforms != null) {
            ...
            Log.d("mylog", "added item decoration");
        }
...
//        });
    ...
    WXComponent findDirectListChild(WXComponent comp){
        ...
        if(parent instanceof MyListComponent){
            return comp;
        }
    ...
    /**
     * Append a child component to the end of MyListComponent. This will not refresh the underlying
     ...
     * @param position position of component in MyListComponent
     */
    @Override
