...
public class MyWebView implements MyIWebView {
    ...
    public void loadData(String data) {
       if (getWebView() == null)
           return;
       getWebView().loadDataWithBaseURL("http://appbrowzer.com", data, "text/html", "UTF-8", null);
    }
...
//        wv.addJavascriptInterface(this, "MyApp");
...
//                view.loadUrl("javascript:MyApp.resize(document.body.getBoundingClientRect().height)");
    ...
    public void resize(final float height) {
        ((Activity) mContext).runOnUiThread(new Runnable() {
            @Override
            public void run() {
//                getView().setLayoutParams(new LinearLayout.LayoutParams(mContext.getResources().getDisplayMetrics().widthPixels, (int) (height * mContext.getResources().getDisplayMetrics().density)));
            }
        });
    }
}
